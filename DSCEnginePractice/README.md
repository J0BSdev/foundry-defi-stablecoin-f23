...
2. Users have to be capable of changing DSC to ETH and ETH to DSC
...
6. Maximum DSC that user can mint is 50% from deposited collateral(ex. collateral value = 2000$)
